...
public class RouteGroupController
{
	...
	@RequestMapping(value = "/{routeGroupId}", method = RequestMethod.GET)
	@PreAuthorize("hasRole('ROLE_USER')")
	public ResponseEntity<RouteGroupResource> getRouteGroupResource(@PathVariable String routeGroupId)
	{
	...
	@RequestMapping(value = "/{routeGroupId}/routes", method = RequestMethod.POST)
	@PreAuthorize("hasRole('ROLE_USER')")
	public ResponseEntity<RouteResource> createRoute(@PathVariable String routeGroupId, @RequestBody RouteResource sentResource)
	{
	...
	@PreAuthorize("hasRole('ROLE_USER')")
	public ResponseEntity<RouteListResource> findAllRoutes(@PathVariable String routeGroupId)
	{
		try
		{
	...
	@RequestMapping(value = "/{routeGroupId}/route-schedules", method = RequestMethod.GET)
	@PreAuthorize("hasRole('ROLE_USER')")
	public ResponseEntity<RouteSchedListResource> findAllSchedules(@PathVariable String routeGroupId)
	{
		try
		{
	...
	@RequestMapping(value = "/{routeGroupId}/route-schedules", method = RequestMethod.POST)
	@PreAuthorize("hasRole('ROLE_USER')")
	public ResponseEntity<RouteSchedResource> createRouteSchedule(@PathVariable String routeGroupId, @RequestBody RouteSchedResource sentResource)
	{
	...
	@PreAuthorize("hasRole('ROLE_USER')")
	public ResponseEntity<RouteGroupResource> updateRouteGroup(@PathVariable String routeGroupId, @RequestBody RouteGroupResource sentResource)
	{
		RouteGroup updatedEntity = null;
		try
		{
			updatedEntity = routeGroupService.updateRouteGroup(routeGroupId, sentResource.toRouteGroup());

			if (updatedEntity != null)
			{
				RouteGroupResource res = new RouteGroupResourceAsm().toResource(updatedEntity);
				return new ResponseEntity<RouteGroupResource>(res, HttpStatus.OK);
			} else
			{
				return new ResponseEntity<RouteGroupResource>(HttpStatus.NOT_FOUND);
	...
	@PreAuthorize("hasRole('ROLE_USER')")
	public void deleteRouteDetail(@PathVariable String routeGroupId)
	{
		try
		{
